<template>
  <div class="about-us">
    <TopBanner>
      <b-container>
        <b-row class="h-100 align-items-center py-5">
          <div class="col-lg-6">
            <h1 class="display-4">About sheanch engineering ltd.</h1>
            <p class="lead text-muted mb-0">We are committed to providing you with a safe home.</p>
          </div>
          <div class="col-lg-6 d-none d-lg-block">
            <img src="../assets/frontend/images/aboutus_illu.png" alt="" class="img-fluid">
          </div>
        </b-row>
      </b-container>
    </TopBanner>
      ...
      <div class="container py-5">
        <div class="row align-items-center mb-5">
          ...
          <div class="col-lg-5 px-5 mx-auto order-1 order-lg-2"><img
              src="https://bootstrapious.com/i/snippets/sn-about/img-1.jpg" alt="" class="img-fluid mb-4 mb-lg-0"></div>
        </div>
...
<script>
import TopBanner from "@/components/frontend/TopBanner";
import Newsletter from "@/components/frontend/Newsletter";
export default {
  name: 'about-us',
  auth: false,
  components: { TopBanner, Newsletter }
}
</script>
